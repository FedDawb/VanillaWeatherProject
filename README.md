...
git clone [https://github.com/FedDawb/VanillaWeatherProject] https://github.com/FedDawb/VanillaWeatherProject
cd your-repo-name


2. Run the Backend (with Docker) Navigate to the backend directory and build the Docker image.
...
3. Run the Frontend Open a new, separate terminal window. Navigate to the frontend directory and start the simple Python web server.

cd frontend
python -m http.server 8001


4. View the Application Open your web browser and navigate to: http://localhost:8001
